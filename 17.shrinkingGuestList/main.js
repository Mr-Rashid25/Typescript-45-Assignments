...
while (guestList.length > 2) {
    ...
    console.log(`Sorry dear friend: ${removeGuest} You are not invited to dinner due to the unavailability of a large dinner table.`);
}
// inviting remaining 2 guest
console.log(`\nInvitation message to two remaining guest.\n`);
let twoGuest = guestList.length;
guestList.forEach((twoGuest) => console.log(`Fortunately, ${twoGuest} you are still invited for dinner.`));
